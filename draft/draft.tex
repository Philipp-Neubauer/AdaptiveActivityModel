...
Food concentration$^1$ & $\Theta \gamma \approx h w^{p-q}$ (g$_C$/time) \\
Coef.~for clearance rate$^1$ & $\gamma$ \\
...
\hline
\multicolumn{2}{p@\textwidth}{This is under the assumption that the amount of encountered food is roughly independent of body size.  This gives and order-of-magnitude estimate of the product $\Theta \gamma $.}
\end{tabular}
\end{table}
